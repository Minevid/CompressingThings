 ...
 */
public class BlockQuadrupleCompressedDirt extends Block {
    public BlockQuadrupleCompressedDirt()
    {
        super(Material.GRASS);
        setRegistryName("quadruplecompresseddirt");
        setUnlocalizedName(References.MOD_ID + ".quadruplecompresseddirt");
