 ...
 */
public class BlockQuintupleCompressedDirt extends Block {

    public BlockQuintupleCompressedDirt() {
        super(Material.GRASS);
        setRegistryName("quintuplecompresseddirt");
        setUnlocalizedName(References.MOD_ID + ".quintuplecompresseddirt");
